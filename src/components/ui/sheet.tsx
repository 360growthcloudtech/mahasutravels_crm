...
function SheetHeader({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      className={cn("flex shrink-0 flex-col gap-1.5 border-b border-border-soft px-6 py-5 pr-12", className)}
      {...props}
    />
  );
}
...
function SheetFooter({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      className={cn(
        "mt-auto flex shrink-0 flex-col-reverse gap-2 border-t border-border-soft px-6 py-4 sm:flex-row sm:justify-end",
        className
      )}
      {...props}
    />
