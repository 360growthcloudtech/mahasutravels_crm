    ...
    <div className="min-h-screen bg-[#f4f5f8] text-ink-text print:bg-white">
      ...
      <article className="mx-auto my-6 max-w-[900px] overflow-hidden rounded-xl border border-border bg-white shadow-[0_8px_24px_rgba(18,23,43,0.06)] print:my-0 print:max-w-none print:rounded-none print:border-0 print:shadow-none">
        ...
        <section className="border-b border-border px-6 py-5">
          ...
          <div
            className="mt-2 text-sm leading-relaxed text-slate prose prose-sm max-w-none"
              ...
              >
                <div className="flex items-start gap-3">
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <div
                      className="mt-1 text-xs leading-relaxed text-slate prose prose-xs max-w-none"
                      dangerouslySetInnerHTML={{ __html: stop.detail }}
                    />
                    {(stop.hotelName || stop.hotelId) && (
                      <div className="mt-2 flex items-center gap-1.5 rounded-md bg-slate-50 px-2.5 py-1.5 text-xs text-slate border">
                        <BedDouble className="size-3.5 text-teal shrink-0" />
                        <span className="font-medium text-ink-text">Overnight Stay:</span>
